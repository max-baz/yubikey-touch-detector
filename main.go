...
func main() {
	...
	flag.StringVar(&notificationTitle, "notify-title", notificationTitle, "desktop notification title template")
	flag.StringVar(&notificationBody, "notify-body", notificationBody, "desktop notification body template")
